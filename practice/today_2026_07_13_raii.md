# 2026-07-13 练习实现：RAII 与智能指针

对应练习：[2026-07-13：RAII 与智能指针所有权](/roadmap/daily/2026-07-13)
...
- `ResourceGuard` 禁止拷贝，支持移动，析构只释放有效资源。
- `unique_ptr` 通过函数参数表达“接管所有权”。
- `shared_ptr` 用于共享生命周期，`weak_ptr` 用于观察对象是否还活着。
